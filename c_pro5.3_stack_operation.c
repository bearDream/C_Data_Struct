...
int cal_formula(char *formula){
    ...
    while(formula[i] != '\0'){
        ...
        if(formula[i] >= '0' && formula[i] <= '9'){
            ...
            int num1 = converse_char_int(pop(nums));
            int num2 = converse_char_int(pop(nums));
            // printf("%d \n", num1);
    ...
    return converse_char_int(pop(nums));
}
